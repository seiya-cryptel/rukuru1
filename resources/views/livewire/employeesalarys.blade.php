<div>
    ...
    <div class="col-md-8 py-1">
        ...
        <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded" wire:click.prevent="saveEmployeeSalary">{{ __('Save') }}</button>
        <button wire:click.prevent="cancelEmployeeSalary()" class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-1 px-2 rounded">{{ __('Cancel') }}</button>
    </div>
