        ...
        <tr>
            ...
            <td style="width: 12rem;">
                <select 
                    ...
                    <option value="">{{ __('Client work place') }}</option>
        ...
        <tr>
            ...
            <td>
                @if(count($refClientWorkTypes) > 0)
                    <select 
                        tabindex="11" 
                        class="form-control @error('clientworktype_id') is-invalid @enderror text-sm py-1" 
                        id="clientworktype_id" 
                        wire:model="clientworktype_id" 
                        wire:change="updateClientWorkTypeId($event.target.value)">
    ...
    {{-- 作業種別名 --}}
        <tr>
            ...
            <td style="width: 12rem;">
                <input type="text" 
                    tabindex="21" 
                    class="form-control text-sm py-1 bg-gray-100" 
                    id="wt_name" 
                    wire:model="wt_name" 
                    style="width: 12rem;" 
                    readonly="readonly">
    ...
    {{-- 作業時間 --}}
        <tr>
            ...
            <td style="width: 12rem;">
                <input type="text" 
                    class="form-control text-sm py-1 bg-gray-100" 
                    id="wt_day_night_name" 
                    wire:model="wt_day_night_name" 
                    style="width: 4rem;" 
                    readonly="readonly">
            </td>
    ...
    <table class="text-sm">
        ...
        <tr>
            ...
            <td>
                <input type="text" 
                    tabindex="31" 
                    class="form-control @error('wt_pay_std') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_pay_std }}" 
                    id="wt_pay_std" 
                    wire:model="wt_pay_std" 
                    wire:change="updateWage($event.target.value, 'wt_pay_std')" 
                    style="width: 4rem;">
                @error('wt_pay_std') 
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <td>
                <input type="text" 
                    tabindex="32" 
                    class="form-control @error('wt_bill_std') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_bill_std }}" 
                    id="wt_bill_std" 
                    wire:model="wt_bill_std" 
                    wire:change="updateWage($event.target.value, 'wt_bill_std')" 
                    style="width: 4rem;">
                @error('wt_bill_std') 
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <tr>
            ...
            <td>
                <input type="text" 
                    tabindex="41" 
                    class="form-control @error('wt_pay_ovr') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_pay_ovr }}" 
                    id="wt_pay_ovr" 
                    wire:model="wt_pay_ovr" 
                    wire:change="updateWage($event.target.value, 'wt_pay_ovr')" 
                    style="width: 4rem;">
                @error('wt_pay_std') 
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <td>
                <input type="text" 
                    tabindex="42" 
                    class="form-control @error('wt_bill_ovr') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_bill_ovr }}" 
                    id="wt_bill_ovr" 
                    wire:model="wt_bill_ovr" 
                    wire:change="updateWage($event.target.value, 'wt_bill_ovr')" 
                    style="width: 4rem;">
                @error('wt_bill_ovr') 
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <tr>
            ...
            <td>
                <input type="text" 
                    tabindex="51" 
                    class="form-control @error('wt_pay_ovr_midnight') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_pay_ovr_midnight }}" 
                    id="wt_pay_ovr_midnight" 
                    wire:model="wt_pay_ovr_midnight" 
                    wire:change="updateWage($event.target.value, 'wt_pay_ovr_midnight')" 
                    style="width: 4rem;">
            ...
            <td>
                <input type="text" 
                    tabindex="52" 
                    class="form-control @error('wt_bill_ovr_midnight') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_bill_ovr_midnight }}" 
                    id="wt_bill_ovr_midnight" 
                    wire:model="wt_bill_ovr_midnight" 
                    wire:change="updateWage($event.target.value, 'wt_bill_ovr_midnight')" 
                    style="width: 4rem;">
        ...
        <tr>
            ...
            <td>
                <input type="text" 
                    tabindex="61" 
                    class="form-control @error('wt_pay_holiday') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_pay_holiday }}" 
                    id="wt_pay_holiday" 
                    wire:model="wt_pay_holiday"
                    wire:change="updateWage($event.target.value, 'wt_pay_holiday')" 
                    style="width: 4rem;">
            ...
            <td>
                <input type="text" 
                    tabindex="62" 
                    class="form-control @error('wt_bill_holiday') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_bill_holiday }}" 
                    id="wt_bill_holiday" 
                    wire:model="wt_bill_holiday" 
                    wire:change="updateWage($event.target.value, 'wt_bill_holiday')" 
                    style="width: 4rem;">
        ...
        <tr>
            ...
            <td>
                <input type="text" 
                    tabindex="71" 
                    class="form-control @error('wt_pay_holiday_midnight') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_pay_holiday_midnight }}" 
                    id="wt_pay_holiday_midnight" 
                    wire:model="wt_pay_holiday_midnight"
                    wire:change="updateWage($event.target.value, 'wt_pay_holiday_midnight')" 
                    style="width: 4rem;">
            ...
            <td>
                <input type="text" 
                    tabindex="72" 
                    class="form-control @error('wt_bill_holiday_midnight') is-invalid @enderror text-sm py-1 text-right {{ $bg_wt_bill_holiday_midnight }}" 
                    id="wt_bill_holiday_midnight" 
                    wire:model="wt_bill_holiday_midnight" 
                    wire:change="updateWage($event.target.value, 'wt_bill_holiday_midnight')" 
                    style="width: 4rem;">
