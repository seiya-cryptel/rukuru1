...
<tr class="border-b">
    <table class="text-sm">
        ...
        <tr>
            ...
            <td style="width: 12rem;">
                <input type="text" class="form-control @error('wt_lunch_break') is-invalid @enderror text-sm py-1" id="wt_lunch_break" wire:model="wt_lunch_break" wire:change="timeChange($event.target.value, 'wt_lunch_break')" style="width: 4rem;">
