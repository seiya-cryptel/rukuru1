    ...
    <table class="text-sm">
        <tr>
            ...
            <td style="width: 16rem;">
                <select tabindex="0" class="form-control @error('client_id') is-invalid @enderror text-sm py-1" id="client_id" wire:model="client_id" wire:change="updateClientId($event.target.value)">
            ...
            <td style="width: 12rem;">
                <select tabindex="1" class="form-control @error('clientplace_id') is-invalid @enderror text-sm py-1" id="clientplace_id" wire:model="clientplace_id" wire:change="updateClientPlaceId($event.target.value)">
...
<tr class="border-b">
    <table class="text-sm">
        ...
        <tr>
            ...
            <td style="width: 16rem;">
                <input type="text" tabindex="11" class="form-control @error('wt_cd') is-invalid @enderror text-sm py-1" id="wt_cd" placeholder="{{ __('Code') }}" wire:model="wt_cd" style="width: 4rem;">
                @error('wt_cd') 
                    <span class="text-danger" style="color: red;">{{ $message }}</span>
                @enderror
            </td>
        {{-- 作業種別名 --}}
            <td style="width: 8rem;"><label for="wt_name">{{ __('Work Type') . __('Name') }}</label><span class="text-lg" style="color: red;">*</span></td>
            <td style="width: 12rem;">
                <input type="text" tabindex="12" class="form-control @error('wt_name') is-invalid @enderror text-sm py-1" id="wt_name" placeholder="{{ __('Work Type') . __('Name') }}" wire:model="wt_name" style="width: 12rem;">
                @error('wt_name') 
                    <span class="text-danger" style="color: red;">{{ $message }}</span>
                @enderror
            </td>
...
<tr class="border-b">
    <table class="text-sm">
        ...
        <tr>
            ...
            <td style="width: 12rem;">
                <select tabindex="21" class="form-control @error('wt_day_night') is-invalid @enderror text-sm py-1" id="wt_day_night" wire:model="wt_day_night">
        ...
        <tr>            
            ...
            <td style="width: 12rem;">
                <input type="text" tabindex="22" class="form-control @error('wt_work_start') is-invalid @enderror text-sm py-1" id="wt_work_start" wire:model="wt_work_start" wire:change="timeChange($event.target.value, 'wt_work_start')" style="width: 4rem;">
                @error('wt_work_start') 
                    <span class="text-danger" style="color: red;">{{ $message }}</span>
                @enderror
                例 8:00
            ...
            <td style="width: 12rem;">
                <input type="text" tabindex="23" class="form-control @error('wt_work_end') is-invalid @enderror text-sm py-1" id="wt_work_end" wire:model="wt_work_end" wire:change="timeChange($event.target.value, 'wt_work_end')" style="width: 4rem;">
                @error('wt_work_end') 
                    <span class="text-danger" style="color: red;">{{ $message }}</span>
                @enderror
                例 17:00
