<div>
    <form>
        ...
        <tr class="border-b">
            <th><label for="cl_pl_cd">{{ __('Code') }}</label></th>
            <td>
        ...
        <tr class="border-b">
            <th><label for="cl_pl_name">{{ __('Client') . __('Name') }}</label></th>
            <td>
        ...
        <tr class="border-b">
            <th><label for="cl_pl_kana">{{ __('Client') . __('Kana') }}</label></th>
            <td>
        ...
        <tr class="border-b">
            <th><label for="cl_pl_alpha">{{ __('Client') . __('Alpha') }}</label></th>
            <td>
        ...
        <tr class="border-b">
            <td colspan="2">
                <button wire:click.prevent="updateClientPlace()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">{{ __('Update') }}</button>
