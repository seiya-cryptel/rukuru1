<div>
    <form>
        ...
        <tr class="border-b">
            <td colspan="2">
                <button wire:click.prevent="updatePriceTable()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">{{ __('Update') }}</button>
                <button wire:click.prevent="cancelPriceTable()" class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-1 px-2 rounded">{{ __('Cancel') }}</button>
            </td>
        </tr>
        </table>
    </form>
