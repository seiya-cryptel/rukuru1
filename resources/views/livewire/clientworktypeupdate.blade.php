<div>
    <form>
        ...
        <tr class="border-b">
            <td colspan="2">
                <button wire:click.prevent="updateClientWorktype2()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold text-sm py-1 px-2 rounded" data-save="true">{{ __('Update') }}</button>
