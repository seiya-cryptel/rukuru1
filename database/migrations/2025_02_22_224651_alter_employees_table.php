...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            $table->decimal('empl_paid_leave_pay', 12, 4)->default(0)->comment('有給休暇時給')->after('empl_resign_date');
            $table->bigInteger('empl_main_client_id')->nullable()->comment('主な顧客')->after('empl_paid_leave_pay');
            $table->bigInteger('empl_mail_clientplace_id')->nullable()->comment('主な顧客部門')->after('empl_main_client_id');
        });
        Schema::table('xlog_employees', function (Blueprint $table) {
            $table->decimal('empl_paid_leave_pay', 12, 4)->comment('有給休暇時給')->after('empl_resign_date');
            $table->bigInteger('empl_main_client_id')->nullable()->comment('主な顧客')->after('empl_paid_leave_pay');
            $table->bigInteger('empl_mail_clientplace_id')->nullable()->comment('主な顧客部門')->after('empl_main_client_id');
        });
        ...
        BEGIN
            INSERT INTO `xlog_employees`
                (`opr`, `id_empl`, `empl_cd`, 
                    ...
                    `empl_paid_leave_pay`, `empl_main_client_id`, `empl_mail_clientplace_id`,
            ...
            VALUES 
                ("U", OLD.id, OLD.empl_cd, 
                    ...
                    OLD.empl_paid_leave_pay, OLD.empl_main_client_id, OLD.empl_mail_clientplace_id,
    ...
    public function down(): void
    {
        ...
        Schema::table('employees', function (Blueprint $table) {
            $table->dropColumn('empl_paid_leave_pay');
            $table->dropColumn('empl_main_client_id');
            $table->dropColumn('empl_mail_clientplace_id');
        });
        Schema::table('xlog_employees', function (Blueprint $table) {
            $table->dropColumn('empl_paid_leave_pay');
            $table->dropColumn('empl_main_client_id');
