...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            $table->string('empl_wt_cd_list', 255)->nullable()->comment('プリセット作業種別')->after('empl_main_client_name');
        });
        ...
        BEGIN
            INSERT INTO `xlog_employees`
                (`opr`, `id_empl`, `empl_cd`, 
                    ...
                    `empl_main_client_name`, `empl_wt_cd_list`, `empl_notes`)
            VALUES 
                ("U", OLD.id, OLD.empl_cd, 
                    ...
                    OLD.empl_main_client_name, OLD.empl_wt_cd_list, OLD.empl_notes);
        END');
    ...
    public function down(): void
    {
        ...
        Schema::table('employees', function (Blueprint $table) {
            $table->dropColumn('empl_wt_cd_list');
        });
        Schema::table('xlog_employees', function (Blueprint $table) {
            $table->dropColumn('empl_wt_cd_list');
        });
